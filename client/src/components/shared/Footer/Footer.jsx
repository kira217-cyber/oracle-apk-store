  ...
  return (
    <footer className="bg-white text-black mb-10 md:mb-0">
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="hidden md:flex items-center justify-between gap-2 md:gap-8">
            {/* Quick Links */}
            <div>
              <h3 className="text-red-500 underline font-bold mb-3">
                Quick Links
              </h3>
          ...
          <div className="flex items-center justify-between gap-2 mt-4 md:hidden md:gap-8">
            {/* Quick Links */}
            <div>
              <h3 className="text-red-500 underline font-bold mb-3">
                Quick Links
